      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
			  ...
			  <li>
                <a href="height.html">
                <i class="fa fa-th"></i> 
                <span>Student Height & Weight</span>
                </a>
              </li>
		...
		<!-- //header-ends -->
			...
			String status = "pending";
				try
				{
					PreparedStatement ps = con.prepareStatement("Select * from complaint where school_id = ? and status = ?");
					ps.setString(1, s_id);
			...
			%>
						<tbody> 
							<tr> 
								...
								<td><a href="delete_complaint.jsp?id=<%=rs.getInt(1)%>">delete</a></td>  
							</tr> 
			<% 		
					}
				}
			...
			%>		
				...
				<h2 class="title1">Add Complaint</h2>
				...
				<form action="Add_Complaint" method="post">
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								<input type="text" class="form-control1" name ="complaint" placeholder="Write Complaint">
							</div>
						</div>
					</div>
				<centre><button type="submit">Add Complaint</button></centre>
				</form>
			</div>
