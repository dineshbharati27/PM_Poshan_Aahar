					...
					<div class="form-group">
						...
						<form action ="Update_Student" method="post">
							<div class="col-md-6 grid_box1">
								<input type="text" class="form-control1" name="contact" placeholder="Enter Student Contact N0.">
							</div>
							<div class="col-md-6 grid_box1">
								<input type="text" class="form-control1" name="class" placeholder="Enter Student Class">
							</div>
							<div class="col-md-6 grid_box1">
								<input type="text" class="form-control1" name="height" placeholder="Enter Student height">
							</div>
							<div class="col-md-6 grid_box1">
								<input type="text" class="form-control1" name="weight" placeholder="Enter Student weight">
							</div>
							<div class="col-md-2 grid_box1">
								<centre><button type="submit">update</button></centre>
							</div>
						</form>
							<div class="clearfix"> </div>
						</div>
