      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			...
			<form action="view_Report" method ="post">
				<h2 class="title1">Search School</h2>
				<div class="grids widget-shadow">
					<div class="form-group">
						<div class="row">
							<div class="col-md-12">
								<input type="text" class="form-control1" name ="Sid" placeholder="school id">
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
				<centre><button type="submit">view</button></centre>
				</div>
		...
		%>
			...
			<centre><h2 class="title1">report of a school:</h2></centre>
				<h3>---------------------------------------------</h3>
			<centre><h2 class="title1">Average Height at Beginning = <%=height %></h2></centre>
